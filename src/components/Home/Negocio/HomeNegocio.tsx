      ...
      <div className="container grid grid-cols-4 gap-6 mt-8 mx-auto">
        ...
        >
          <p>
            ...
            todos los campos y listo. Editalos cuando quieras y elimina los que
            ya no necesites.
          </p>
        </HomeNegocioCard>
        <HomeNegocioCard
        ...
        >
          <p>
            ...
            los pedidos, visualiza los detalles de cada uno de ellos y mucho
            más.
          </p>
        </HomeNegocioCard>
        <HomeNegocioCard
        ...
        >
          <p>
            ...
            agrega una descripción, sube fotos y mucho más. Recuerda que una
            buena presentación es clave para atraer a tus clientes.
          </p>
        </HomeNegocioCard>
        <HomeNegocioCard
        ...
        >
          <p>
            ...
            ofertas, y mucho más. Recuerda que una buena atención al cliente es
            clave para fidelizar a tus clientes.
          </p>
        </HomeNegocioCard>
      </div>
    </section>
