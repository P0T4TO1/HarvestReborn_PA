...
export const ProfileForm = ({ profile, isEditing }: ProfileFormProps) => {
  ...
  const {
    ...
    defaultValues: {
      dueneg: {
        nombre_dueneg: user?.duenonegocio?.nombre_dueneg ?? "",
        apellidos_dueneg: user?.duenonegocio?.apellidos_dueneg ?? "",
        fecha_nacimiento: user?.duenonegocio?.fecha_nacimiento ?? "",
        dia_nacimiento: user?.duenonegocio?.fecha_nacimiento
          ?.toString()
          .split("-")[2]
          .split("T")[0],
        mes_nacimiento:
          months.find(
            (month) =>
              month.key ===
              user?.duenonegocio?.fecha_nacimiento?.toString().split("-")[1]
          )?.value ?? "",
        year_nacimiento: user?.duenonegocio?.fecha_nacimiento
          ?.toString()
          .split("-")[0],
        negocio: {
          nombre_negocio: user?.duenonegocio?.negocio?.nombre_negocio ?? "",
          direccion_negocio:
            user?.duenonegocio?.negocio?.direccion_negocio ?? "",
          calle: user?.duenonegocio?.negocio?.direccion_negocio?.split(",")[0],
          colonia:
            user?.duenonegocio?.negocio?.direccion_negocio?.split(",")[1],
          alcaldia:
            user?.duenonegocio?.negocio?.direccion_negocio?.split(",")[2],
          cp: user?.duenonegocio?.negocio?.direccion_negocio?.split(",")[3],
          telefono_negocio: user?.duenonegocio?.negocio?.telefono_negocio ?? "",
          email_negocio: user?.duenonegocio?.negocio?.email_negocio ?? "",
        },
      },
      cliente: {
        nombre_cliente: user?.cliente?.nombre_cliente ?? "",
        apellidos_cliente: user?.cliente?.apellidos_cliente ?? "",
        telefono_cliente: user?.cliente?.telefono_cliente ?? "",
        fecha_nacimiento: user?.cliente?.fecha_nacimiento ?? "",
        nombre_negocio: user?.cliente?.nombre_negocio ?? "",
        direccion_negocio: user?.cliente?.direccion_negocio ?? "",
        dia_nacimiento: user?.cliente?.fecha_nacimiento
          ?.toString()
          .split("-")[2]
          .split("T")[0],
        mes_nacimiento:
        ...
        year_nacimiento: user?.cliente?.fecha_nacimiento
          ?.toString()
          .split("-")[0],
        calle: user?.cliente?.direccion_negocio?.split(",")[0],
        colonia: user?.cliente?.direccion_negocio?.split(",")[1],
        alcaldia: user?.cliente?.direccion_negocio?.split(",")[2],
        cp: user?.cliente?.direccion_negocio?.split(",")[3],
      },
    },
  });
